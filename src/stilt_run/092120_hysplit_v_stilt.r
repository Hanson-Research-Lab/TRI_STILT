...
# User inputs ------------------------------------------------------------------
project <- 'STILT'
stilt_wd <- file.path('/uufs/chpc.utah.edu/common/home/u0890227', project)
...
# Receptor location(s)
receptors <- readRDS('092120_hysplit_v_stilt.rds')
receptors$run_time=as.POSIXct('1990-01-01 00:00:00', tz='UTC')
